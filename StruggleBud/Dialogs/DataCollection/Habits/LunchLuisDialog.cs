...
namespace StruggleBud.Dialogs.DataCollection.Habits
{
    ...
    public class LunchLuisDialog : LuisDialog<object>
    {

        [LuisIntent("Datetime")]
        private Task LunchTimeManualInput(IDialogContext context, IAwaitable<object> result, Microsoft.Bot.Builder.Luis.Models.LuisResult luisResult)
        {
