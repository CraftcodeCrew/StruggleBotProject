...
namespace StruggleBud.Dialogs.DataCollection.Habits
{
    ...
    public class DinnerLuisDialog : LuisDialog<object>
    {

        [LuisIntent("Datetime")]
        private Task DinnerTimeManualInput(IDialogContext context, IAwaitable<object> result, Microsoft.Bot.Builder.Luis.Models.LuisResult luisResult)
        {
            context.UserData.SetValue(UserData.LunchKey, luisResult.Entities[0].Entity);
            context.Done(true);
