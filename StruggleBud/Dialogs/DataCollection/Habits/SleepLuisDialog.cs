...
namespace StruggleBud.Dialogs.DataCollection.Habits
{
    ...
    public class SleepLuisDialog : LuisDialog<object>
    {
        [LuisIntent("Datetime")]
        private Task SleepTimeManualInput(IDialogContext context, IAwaitable<object> result, Microsoft.Bot.Builder.Luis.Models.LuisResult luisResult)
        {
            context.UserData.SetValue(UserData.SleepKey, luisResult.Entities[0].Entity);
            context.Done(true);
